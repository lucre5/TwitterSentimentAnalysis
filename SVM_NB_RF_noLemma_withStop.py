...
# Step - d : Remove Stop words, Non-Numeric.
...
Train_X, Test_X, Train_Y, Test_Y = model_selection.train_test_split(df['text_prep'],df['Category'],test_size=0.3, random_state=4)
...
plt.xlabel('Recall')
plt.ylabel('Precision')
plt.title('Extension of Precision-Recall curve to multi-class model-no lemma/no stop- RF')
